...
dat_exp_H_E=GSE54129_data[which(rownames(GSE54129_data) %in% c('H2AFZ','E2F2')),]
...
pdf('/public/workspace/liuqzh/gastric_cancer/bulk_result/cor_GSE54129_H2AFZ_E2F2.pdf',height=5,width=5)
p1
dev.off()