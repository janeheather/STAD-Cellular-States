...
"/public/workspace/liuqzh/gastric_cancer/Anuja_celltype_mac_NMF/"
"/public/workspace/liuqzh/gastric_cancer/CRA002586_celltype_mac_NMF/"
"/public/workspace/liuqzh/gastric_cancer/GSE150290_celltype_mac_NMF/"
"/public/workspace/liuqzh/gastric_cancer/GSE167297_celltype_mac_NMF/"
"/public/workspace/liuqzh/gastric_cancer/GSE183904_celltype_mac_NMF/"

Path_file="/public/workspace/liuqzh/gastric_cancer/GSE183904_celltype_mac_NMF/"
for(Sample in list.files(Path_file)){
	...
	saveRDS(gene_spectra_score, paste(Path_file,Sample,'/example_data/',Sample,'_2_9_Mac_0.4_0.7_0.2_','Module_result.rds',sep=''))
}

Data_path=c("/public/workspace/liuqzh/gastric_cancer/Anuja_celltype_mac_NMF/",
			"/public/workspace/liuqzh/gastric_cancer/CRA002586_celltype_mac_NMF/",
			"/public/workspace/liuqzh/gastric_cancer/GSE150290_celltype_mac_NMF/",
			"/public/workspace/liuqzh/gastric_cancer/GSE167297_celltype_mac_NMF/",
			"/public/workspace/liuqzh/gastric_cancer/GSE183904_celltype_mac_NMF/")
...
for(Path_file in Data_path){
	...
	for(Sample in Sample_List){
		...
		Module_result_file=Path[grep('2_9_Mac_0.4_0.7_0.2_Module_result.rds',Path)]
...
######
saveRDS(nmf_score_result, '/public/workspace/liuqzh/gastric_cancer/NMF_DATA/Mac_nmf_score_result_0.4_0.7_0.2_DATA.rds')
saveRDS(nmf_programs, '/public/workspace/liuqzh/gastric_cancer/NMF_DATA/Mac_nmf_programs_0.4_0.7_0.2_DATA.rds')

nmf_score_result=readRDS('/public/workspace/liuqzh/gastric_cancer/NMF_DATA/Mac_nmf_score_result_0.4_0.7_0.2_DATA.rds')
nmf_programs=readRDS('/public/workspace/liuqzh/gastric_cancer/NMF_DATA/Mac_nmf_programs_0.4_0.7_0.2_DATA.rds')
...
# 绘制轮廓系数图
pdf('/public/workspace/liuqzh/gastric_cancer/NMF_DATA/Mac_Silhouette.pdf',width=5,height=5,useDingbats=F)
...
pdf('/public/workspace/liuqzh/gastric_cancer/NMF_DATA/Mac_intersect_hc.pdf',width=50,height=10,useDingbats=F)
...
#save.image(file = '/public/workspace/liuqzh/gastric_cancer/NMF_DATA/Mac_NMF_75_30_20.RData')
...
library(dplyr)
library(pheatmap)
load(file='/public/workspace/liuqzh/gastric_cancer/NMF_DATA/Mac_NMF_75_30_20.RData')

#write.table(nmf_intersect,'/public/workspace/liuqzh/gastric_cancer/NMF_DATA/Mac_nmf_intersect_data.txt',col.names=T, sep='\t')
#write.table(cluster_labels,'/public/workspace/liuqzh/gastric_cancer/NMF_DATA/Mac_cluster_labels_data.txt',col.names=T, sep='\t')
...
pdf('/public/workspace/liuqzh/gastric_cancer/NMF_DATA/Mac_Heatmap_subtype.pdf',width=8,height=8,useDingbats=F)
...
write.table(MP_list,'/public/workspace/liuqzh/gastric_cancer/NMF_DATA/Mac_MP_list.txt',col.names=T, sep='\t')
