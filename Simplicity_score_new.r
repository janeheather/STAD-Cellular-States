...
Maligant_MP_1<-read.table('/public/workspace/liuqzh/gastric_cancer/Maligant_MP_1_TCGA_new.txt',header=T,row.names=1)
Maligant_MP_2<-read.table('/public/workspace/liuqzh/gastric_cancer/Maligant_MP_2_TCGA_new.txt',header=T,row.names=1)
Maligant_MP_3<-read.table('/public/workspace/liuqzh/gastric_cancer/Maligant_MP_3_TCGA_new.txt',header=T,row.names=1)
...
write.table(Maligant_MP_1, "/public/workspace/liuqzh/gastric_cancer/Simplicity/Maligant_MP_1_new.txt", row.names = T, sep = "\t")
...
write.table(Maligant_MP_2, "/public/workspace/liuqzh/gastric_cancer/Simplicity/Maligant_MP_2_new.txt", row.names = T, sep = "\t")
...
write.table(Maligant_MP_3, "/public/workspace/liuqzh/gastric_cancer/Simplicity/Maligant_MP_3_new.txt", row.names = T, sep = "\t")
...
Maligant_MP_1<-read.table('/public/workspace/liuqzh/gastric_cancer/Simplicity/Maligant_MP_1_new.txt',header=T,row.names=1)
Maligant_MP_2<-read.table('/public/workspace/liuqzh/gastric_cancer/Simplicity/Maligant_MP_2_new.txt',header=T,row.names=1)
Maligant_MP_3<-read.table('/public/workspace/liuqzh/gastric_cancer/Simplicity/Maligant_MP_3_new.txt',header=T,row.names=1)
...
pdf("/public/workspace/liuqzh/gastric_cancer/Simplicity/DATA_MP_new.pdf",width=12,height=3)
library(circlize)
DATA_MP$simplicity='Low'
DATA_MP$simplicity[which(DATA_MP$Simplicity_score >= 0.05)]='High'
...
###
pdf("/public/workspace/liuqzh/gastric_cancer/Simplicity/DATA_MP_all_result_new.pdf",width=12,height=3)
library(circlize)
df=aa
df$simplicity='Low'
...
pdf("/public/workspace/liuqzh/gastric_cancer/Simplicity/DATA_MP_subtype_new.pdf",width=12,height=3)
