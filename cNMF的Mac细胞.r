...
######
#GSE150290
#Path_file="/public/workspace/liuqzh/gastric_cancer/GSE150290_celltype_mac_NMF/"
#Celltype_file="/public/workspace/liuqzh/gastric_cancer/GSE150290_sample_data/"

#Anuja
#Path_file="/public/workspace/liuqzh/gastric_cancer/Anuja_celltype_mac_NMF/"
#Celltype_file="/public/workspace/liuqzh/gastric_cancer/Anuja_sample_data/"

#CRA002586
#Path_file="/public/workspace/liuqzh/gastric_cancer/CRA002586_celltype_mac_NMF/"
#Celltype_file="/public/workspace/liuqzh/gastric_cancer/CRA002586_sample_data/"

#GSE167297
#Path_file="/public/workspace/liuqzh/gastric_cancer/GSE167297_celltype_mac_NMF/"
...
for(Sample in list.files(Path_file)){
	...
	dat<-subset(dat,subset=single_cell_celltype %in% 'Macrophage')
	##########编码蛋白处理
