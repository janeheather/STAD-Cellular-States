...
pdf('/public/workspace/liuqzh/gastric_cancer/bulk_result/TCGA_STAD_Prolif.pdf',height=5,width=5)
ggsurvplot(
	fit,
	data = cli,
...
pdf('/public/workspace/liuqzh/gastric_cancer/bulk_result/GSE62254_Prolif.pdf',height=5,width=5)
ggsurvplot(
	fit,
	data = cli,
	title = "Kaplan-Meier Survival Curve",
...
pdf('/public/workspace/liuqzh/gastric_cancer/bulk_result/GSE13861_Prolif.pdf',height=5,width=5)
ggsurvplot(
	fit,
	data = cli,
	title = "Kaplan-Meier Survival Curve",
...
fit <- survfit(Surv(OS_m,Death) ~ group, data = cli)
pdf('/public/workspace/liuqzh/gastric_cancer/bulk_result/GSE26253_Prolif.pdf',height=5,width=5)
ggsurvplot(
	fit,
	data = cli,
	title = "Kaplan-Meier Survival Curve",
...
pdf('/public/workspace/liuqzh/gastric_cancer/bulk_result/GSE84426_Prolif.pdf',height=5,width=5)
ggsurvplot(
	fit,
	data = cli,
	title = "Kaplan-Meier Survival Curve",
...
pdf('/public/workspace/liuqzh/gastric_cancer/bulk_result/GSE15459_Prolif.pdf',height=5,width=5)
ggsurvplot(
	fit,
	data = cli,
	title = "Kaplan-Meier Survival Curve",
...
pdf('/public/workspace/liuqzh/gastric_cancer/bulk_result/GSE62254_Prolif_DFS.pdf',height=5,width=5)
ggsurvplot(
	fit,
	data = sur_data,
	title = "Kaplan-Meier Survival Curve",
...
pdf('/public/workspace/liuqzh/gastric_cancer/bulk_result/GSE13861_Prolif_DFS.pdf',height=5,width=5)
ggsurvplot(
	fit,
	data = sur_data,
	title = "Kaplan-Meier Survival Curve",
