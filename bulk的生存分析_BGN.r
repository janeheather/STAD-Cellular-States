...
pdf('/public/workspace/liuqzh/gastric_cancer/survival/TCGA_STAD_BGN.pdf',height=5,width=5)
ggsurvplot(
	fit,
	data = sur_data,
...
pdf('/public/workspace/liuqzh/gastric_cancer/survival/GSE62254_BGN.pdf',height=5,width=5)
ggsurvplot(
	fit,
	data = sur_data,
	title = "Kaplan-Meier Survival Curve",
...
genelist=c('BGN')
####
ssGSEA_Score=t(TPM[which(rownames(TPM) %in% genelist),,drop=F])
ssGSEA_Score=as.data.frame(ssGSEA_Score)
ssGSEA_Score$sample=rownames(ssGSEA_Score)
...
pdf('/public/workspace/liuqzh/gastric_cancer/survival/GSE13861_BGN.pdf',height=5,width=5)
ggsurvplot(
	fit,
	data = sur_data,
	title = "Kaplan-Meier Survival Curve",
...
pdf('/public/workspace/liuqzh/gastric_cancer/survival/GSE26253_BGN.pdf',height=5,width=5)
ggsurvplot(
	fit,
	data = sur_data,
	title = "Kaplan-Meier Survival Curve",
...
pdf('/public/workspace/liuqzh/gastric_cancer/survival/GSE84426_BGN.pdf',height=5,width=5)
ggsurvplot(
	fit,
	data = sur_data,
	title = "Kaplan-Meier Survival Curve",
...
pdf('/public/workspace/liuqzh/gastric_cancer/survival/GSE15459_BGN.pdf',height=5,width=5)
ggsurvplot(
	fit,
	data = sur_data,
	title = "Kaplan-Meier Survival Curve",
...
pdf('/public/workspace/liuqzh/gastric_cancer/survival/GSE62254_BGN_DFS.pdf',height=5,width=5)
ggsurvplot(
	fit,
	data = sur_data,
	title = "Kaplan-Meier Survival Curve",
...
pdf('/public/workspace/liuqzh/gastric_cancer/survival/GSE13861_BGN_DFS.pdf',height=5,width=5)
ggsurvplot(
	fit,
	data = sur_data,
	title = "Kaplan-Meier Survival Curve",
...
coxph_TCGA=coxph_TCGA[which(coxph_TCGA$p_value < 0.05),]
...
###
gene=Reduce(intersect,list(rownames(coxph_GSE62254),
