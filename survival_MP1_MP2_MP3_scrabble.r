...
ssGSEA_Score$MP1_Sub[which(ssGSEA_Score$MP_1 > quantile(ssGSEA_Score$MP_1,0.5))]='MP1'
ssGSEA_Score$MP2_Sub='Other'
ssGSEA_Score$MP2_Sub[which(ssGSEA_Score$MP_2 > quantile(ssGSEA_Score$MP_2,0.5))]='MP2'
ssGSEA_Score$MP3_Sub='Other'
ssGSEA_Score$MP3_Sub[which(ssGSEA_Score$MP_3 > quantile(ssGSEA_Score$MP_3,0.5))]='MP3'
