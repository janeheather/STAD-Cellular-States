...
dat_exp_H_E=dat_exp[which(rownames(dat_exp) %in% c('TUBA1B','E2F2')),]
...
p1<-ggplot(data = data_f, aes(x=TUBA1B, y=E2F2)) +
	...
	stat_cor(method = "pearson", label.x = 4.5, label.y = 5) +  # 添加皮尔逊相关系数
...
pdf('/public/workspace/liuqzh/gastric_cancer/bulk_result/cor_TCGA_STAD_TUBA1B_E2F2.pdf',height=5,width=5)
p1
dev.off()
}
...
p1<-ggplot(data = data_f, aes(x=TUBA1B, y=E2F2)) +
	geom_point(color = "red") +  # 添加红色的点
	stat_smooth(method = "lm", se = TRUE, color = "blue") +  # 添加线性模型拟合线，并显示置信区间，颜色设为蓝色
	stat_cor(method = "pearson", label.x = 3.2, label.y = 2.2) +  # 添加皮尔逊相关系数
	theme_minimal() +  # 使用简洁主题
	labs(
		title = "TUBA1B and E2F2 correlation",
		x = "TUBA1B",
...
pdf('/public/workspace/liuqzh/gastric_cancer/bulk_result/cor_GSE62254_TUBA1B_E2F2.pdf',height=5,width=5)
p1
dev.off()
}
...
p1<-ggplot(data = data_f, aes(x=TUBA1B, y=E2F2)) +
	geom_point(color = "red") +  # 添加红色的点
	stat_smooth(method = "lm", se = TRUE, color = "blue") +  # 添加线性模型拟合线，并显示置信区间，颜色设为蓝色
	stat_cor(method = "pearson", label.x = 7, label.y = 13) +  # 添加皮尔逊相关系数
	theme_minimal() +  # 使用简洁主题
	labs(
		title = "TUBA1B and E2F2 correlation",
		x = "TUBA1B",
...
pdf('/public/workspace/liuqzh/gastric_cancer/bulk_result/cor_GSE26253_TUBA1B_E2F2.pdf',height=5,width=5)
p1
dev.off()
}
...
p1<-ggplot(data = data_f, aes(x=TUBA1B, y=E2F2)) +
	geom_point(color = "red") +  # 添加红色的点
	stat_smooth(method = "lm", se = TRUE, color = "blue") +  # 添加线性模型拟合线，并显示置信区间，颜色设为蓝色
	stat_cor(method = "pearson", label.x = 13, label.y = 11) +  # 添加皮尔逊相关系数
	theme_minimal() +  # 使用简洁主题
	labs(
		title = "TUBA1B and E2F2 correlation",
		x = "TUBA1B",
...
pdf('/public/workspace/liuqzh/gastric_cancer/bulk_result/cor_GSE84426_TUBA1B_E2F2.pdf',height=5,width=5)
p1
dev.off()
}
...
p1<-ggplot(data = data_f, aes(x=TUBA1B, y=E2F2)) +
	geom_point(color = "red") +  # 添加红色的点
	stat_smooth(method = "lm", se = TRUE, color = "blue") +  # 添加线性模型拟合线，并显示置信区间，颜色设为蓝色
	stat_cor(method = "pearson", label.x = 14, label.y = 9) +  # 添加皮尔逊相关系数
	theme_minimal() +  # 使用简洁主题
	labs(
		title = "TUBA1B and E2F2 correlation",
		x = "TUBA1B",
...
pdf('/public/workspace/liuqzh/gastric_cancer/bulk_result/cor_GSE15459_TUBA1B_E2F2.pdf',height=5,width=5)
p1
dev.off()
}
